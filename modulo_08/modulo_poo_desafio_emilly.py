...
Class Livro
    ...
    (Produtos)
    Livros, Periodicos, Jornal, Maps, Gibi/Mangas
        ...
        for livro in self.livros:
            if livro.titulo == titulo_procurado:
                if livro.diponivel:
                    ...
                    print(f"Emprestado de '{livro.titulo}' realizado")
                else:
...
biblioteca_municipal.adicionar_livro(11)
biblioteca_municipal.adicionar_livro(12)
